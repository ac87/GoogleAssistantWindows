...
.\Tools\Grpc\tools\windows_x64\protoc.exe --proto_path proto\ --proto_path Tools\Protoc\include\ --csharp_out Generated\assistant --grpc_out Generated\assistant proto\google\assistant\embedded\v1alpha1\embedded_assistant.proto --plugin=protoc-gen-grpc=.\Tools\Grpc\tools/windows_x64/grpc_csharp_plugin.exe
